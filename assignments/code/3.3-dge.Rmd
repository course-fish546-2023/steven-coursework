...
index -i \
../data/cgigas_roslin_cds_genomic.index \
...
mkdir ../output/kallisto_02

find ../data/*_L001_R1_001.fastq.gz \
| xargs basename -s _L001_R1_001.fastq.gz | xargs -I{} /home/shared/kallisto/kallisto \
quant -i ../data/cgigas_roslin_cds_genomic.index \
-o ../output/kallisto_02/{} \
-t 40 \
...
```{r, eval=TRUE}
countmatrix <- read.delim("../output/kallisto_02.isoform.counts.matrix", header = TRUE, sep = '\t')
...
```{r, eval=TRUE}
# create a data frame with the condition and type of each sample
deseq2.colData <- data.frame(condition=factor(c(rep("control", 12), rep("desicated", 12))), 
                             type=factor(rep("single-read", 24)))
# set the rownames of the data frame to the column names of the count matrix
rownames(deseq2.colData) <- colnames(data)
# create a DESeqDataSet object from the count matrix and the data frame
